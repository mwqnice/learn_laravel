...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{asset('admin/common/bower_components/bootstrap/dist/js/bootstrap.min.js')}}">
  <!-- Font Awesome -->
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('admin/common/plugins/iCheck/square/blue.css')}}">
...
<!-- iCheck -->
<script src="{{asset('admin/common/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
